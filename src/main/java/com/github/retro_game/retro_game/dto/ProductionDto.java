...
public record ProductionDto(
        ...
        int deuteriumProduction,
        int totalEnergy,
        int usedEnergy,
        int availableEnergy,
        int plasmaMetalBonus,
        int plasmaCrystalBonus,
        int plasmaDeuteriumBonus
) {
}
