...
public class OverviewFlightEventDto {
  ...
  public OverviewFlightEventDto(long id, Date at, long startUserId, String startUserName, String startBodyName,
                                CoordinatesDto startCoordinates, @Nullable Long targetUserId,
                                @Nullable String targetUserName, @Nullable String targetBodyName,
                                CoordinatesDto targetCoordinates, @Nullable Long partyId, MissionDto mission,
                                ResourcesDto resources, Map<UnitKindDto, Integer> units, boolean own,
